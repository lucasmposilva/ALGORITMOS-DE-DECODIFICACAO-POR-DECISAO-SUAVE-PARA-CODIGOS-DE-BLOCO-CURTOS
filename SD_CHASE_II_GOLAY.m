function SD_CHASE_II_GOLAY(radius, vEbNo, wethr, output_method)
% parameters of the code
N = 23; K = 12; dmin = 7; t = 3;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% saving results
saveResults(output_method,results,header,["SD_CHASE_II_GOLAY",mat2str(vEbNo)]);